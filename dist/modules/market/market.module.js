...
exports.MarketModule = MarketModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [market_service_1.MarketService, market_gateway_1.MarketGateway, price_feed_service_1.PriceFeedService],
        exports: [market_service_1.MarketService, price_feed_service_1.PriceFeedService],
    })
], MarketModule);
