...
exports.ActivityLogModule = ActivityLogModule = __decorate([
    (0, common_1.Global)(),
    (0, common_1.Module)({
        providers: [activity_log_service_1.ActivityLogService, login_event_service_1.LoginEventService],
        exports: [activity_log_service_1.ActivityLogService, login_event_service_1.LoginEventService],
    })
], ActivityLogModule);
